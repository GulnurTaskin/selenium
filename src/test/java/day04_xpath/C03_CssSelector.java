...
public class C03_CssSelector {
    public static void main(String[] args) throws InterruptedException {
        ...
        // kenarda bulunan fiyat filitresinde min 10, max 200 yazarak filtreleme yapin
        ...
        // filtreleme yapin
            ...
            // filter price kisminin html kodunu aldik.
            // basina . ekleyerek cssSelector'le filter tusuna ulasiyoruz
            // click() ile filter tusuna basiyoruz
        
        driver.findElement(By.cssSelector("button[class='price-range-button']")).sendKeys(Keys.ENTER);
