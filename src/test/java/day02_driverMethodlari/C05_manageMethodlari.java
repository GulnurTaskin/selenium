...
public class C05_manageMethodlari {
    public static void main(String[] args) throws InterruptedException {
        ...
        // zorunlu ilk 3 satira 4. satir ekliyoruz burda
        ...
        implitlyWait() sayfanin yuklenmesi ve/veya
        arayacagimiz webelementlei bulmak icin dinamik olarak tanimlanmis
        maksimum bekleme suresidir.

        Asil amac bekleme degil gorevi yapmaktir

       burada tanimlanan sure gorevi yapmaya cabalayacagi max suredir
       bu sure icerisinde gorevi yapamazsa exception firlatir
